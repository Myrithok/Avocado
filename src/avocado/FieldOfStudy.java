...
enum FieldOfStudy {
	...
	LiberalArtsAndSciencesGeneralStudiesAndHumanities, InterdisciplinaryHumanities, PhilosophyAndReligiousStudies,
	TheologyAndReligiousVocations, History, FrenchLanguageAndLiteratureLetters, SocialAndBehavioralSciencesAndLaw,
	AreaEthnicCulturalGenderAndGroupStudies, CommunicationJournalismAndRelatedPrograms,
	FamilyAndConsumerSciencesHumanSciences, LegalProfessionsAndStudies, InterdisciplinarySocialAndBehaviouralSciences,
	Psychology, SocialSciences, BusinessManagementAndPublicAdministration,
	PublicAdministrationAndSocialServiceProfessions, BusinessManagementMarketingAndRelatedSupportServices,
	PhysicalAndLifeSciencesAndTechnologies, BiologicalAndBiomedicalSciences, BiologicalAndPhysicalSciences,
	OtherInterdisciplinaryPhysicalAndLifeSciences, PhysicalSciences, ScienceTechnologiesTechnicians,
	MathematicsComputerAndInformationSciences, ComputerAndInformationSciencesAndSupportServices, LibraryScience,
	MathematicsAndStatistics, InterdisciplinaryMathematicsComputerAndInformationSciences,
	ArchitectureEngineeringAndRelatedTechnologies, ArchitectureAndRelatedServices, Engineering,
	EngineeringTechnologiesAndEngineeringRelatedFields, HistoricPreservationAndConservation, ConstructionTrades,
	MechanicAndRepairTechnologiesTechnicians, PrecisionProduction, AgricultureNaturalResourcesAndConservation,
	AgricultureAgriculturePperationsAndRelatedSciences, NaturalResourcesAndConservation, HealthAndRelatedFields,
	ParksRecreationLeisureAndFitnessStudies, HealthProfessionsAndRelatedPrograms,
	DentalMedicalAndVeterinaryResidencyPrograms, PersonalProtectiveAndTransportationServices,
	PersonalAndCulinaryServices, MilitaryScienceLeadershipAndOperationalArt, SecurityAndProtectiveServices,
	TransportationAndMaterialsMoving, OtherInstructionalPrograms, MultidisciplinaryInterdisciplinaryStudiesOther;
